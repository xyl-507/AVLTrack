...
class VisionTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
        ...
        ##################################################################
    # --------------------------------------------------------------------------------------------------------------------------------- xyl 
        self.tksa = TKSA_Attention(dim=192, num_heads=4, bias=False)
    # =================================================================================== xyl 
        self.img_dim = 192
        self.text_dim = 192
    ...
    def forward_features_act_token(self, z, x, language_embeddings, t_mask=None, s_mask=None):
        ...
        language_embeddings_xz = language_embeddings.repeat(1, 256+64+1, 1) # 32*321*192
        ...
        for i, l in enumerate(self.blocks):
            ...
            if multi:
                ...
                multi_satges = [5, 8]  # 语言特征选择性地插入, 在第3、6、9层输入language_embeddings_xz
                if i in multi_satges:
                    out = language_embeddings_xz * out + out # 多级语言感知交互模块 xyl
            # ================================================================================ 多级语言感知交互模块 xyl
