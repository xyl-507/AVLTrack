...
class UAVDTNLPDataset(BaseDataset):

    def __init__(self):
        super().__init__()
        # self.base_path = "/home/liuyao/Datasets/smallobject/"
        # self.base_path = '/DATA/lcl/A-data-tiny'
        self.base_path = '/home/xyl/pysot-master/testing_dataset/UAVDT'
        self.language_path = '/home/xyl/pysot-master/testing_dataset/UAVDT-NLP'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        anno_path = '{}/../UAVDT_anno/{}'.format(self.base_path, sequence_info['anno_path'])
        ...
        #############################################################################
        return Sequence(sequence_info['name'], frames, 'uavdtnlp', ground_truth_rect[init_omit:, :],
    ...
    def _get_sequence_info_list(self):
        ...
        for root, dirs, files in os.walk('/home/xyl/pysot-master/testing_dataset/UAVDT'):
            for dir in dirs:
                if dir == 'img':
