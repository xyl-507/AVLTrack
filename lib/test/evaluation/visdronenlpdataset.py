...
class VisDroneNLPDataset(BaseDataset):
    ...
    def __init__(self):
        ...
        self.language_path = '/home/xyl/pysot-master/testing_dataset/VisDrone2019-SOT-test-dev-NLP'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        #############################################################################
        return Sequence(sequence_info['name'], frames, 'visdronenlp', ground_truth_rect[init_omit:, :],
