...
class UAV20LNLPDataset(BaseDataset):
    """ UAV20L dataset.
    ...
    def __init__(self, attribute=None):
        ...
        self.language_path = '/home/xyl/pysot-master/testing_dataset/UAV20L-NLP'
    ...
    def _construct_sequence(self, sequence_info):
        ...
        #############################################################################
        return Sequence(sequence_info['name'], frames, 'uav20lnlp', ground_truth_rect[init_omit:,:],
