...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='/home/dell/WorkSpace/Tracking_by_NL/All-in-One/output', help='root directory to save checkpoints, logs, and tensorboard')
...
def main():
    ...
    if args.mode == "single":
        ...
        train_cmd = "python -m torch.distributed.launch --nproc_per_node %d --master_port %d lib/train/run_training_all_in_one.py " \
