...
The paper can be downloaded from [IEEE Xplore](https://ieeexplore.ieee.org/document/10922151)
...
- Download bert-base-uncased pre-trained weights [[Baidu Yun]](https://pan.baidu.com/s/1LLemKSXPhNRV_JBlEasM-Q?pwd=f5fg) or [[Gitcode]](https://gitcode.com/hf_mirrors/ai-gitcode/bert-base-uncased/tree/main) or [[Hugging Face]](https://huggingface.co/google-bert/bert-base-uncased) and put them to `$PROJECT_ROOT$/AVLTrack/lib/models/pretrained_models/bert-base-uncased`.
